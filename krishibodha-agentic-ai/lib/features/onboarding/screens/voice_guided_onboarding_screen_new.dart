        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // Krishi Avatar
              Expanded(flex: 2, child: _buildKrishiAvatar()),

              const SizedBox(height: 20),

              // Current Message
              Expanded(flex: 1, child: _buildMessageSection()),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            _isListening ? 'आपकी बात सुन रहा हूं...' : _currentMessage,
            style: const TextStyle(
              fontSize: 16,
      ...
      children: [
        ...
        if (_isListening)
          FloatingActionButton.extended(
            ...
            label: const Text('रुकें', style: TextStyle(color: Colors.white)),
          ),
      ],
    );
  }
